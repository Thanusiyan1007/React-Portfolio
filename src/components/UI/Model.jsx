...
const Model = ({ activeId, setShowModel }) => {
  ...
  if (!portfolio) {
    return null; // Avoid rendering if portfolio not found
  }

  return (
    <div className="w-full h-full fixed top-0 left-0 z-[9999] bg-headingcolor bg-opacity-40 flex items-center justify-center">
      <div className="w-[500px] h-[600px] bg-white rounded-[8px] relative p-5 shadow-lg flex flex-col">
        {/* Close Button */}
        <button
        ...
        {/* Footer with Visit Project Button */}
